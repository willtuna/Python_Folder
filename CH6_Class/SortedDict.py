...
class SortedDict(dict):
    ...
    def __init__(self, dictionary=None, key=None, **kwargs):
        ...
        # using key method to sort the keys of the dictionary !!!
    ...
    def update(self, dictionary=None, **kwargs):
        ...
        # using super().keys() since we gonna update self.__keys, if we call SortedDict.keys() it gonna take self.__keys
    ...
    def __setitem__(self, key, value):
        ...
        if key not in self:
            self.__keys.add(key)
        return super().__setitem__(key, value)# return base class for support chaining
        # avoid infinite loop
    ...
    def copy(self):
        ...
        "{'E': 2, 'I': 3, 'N': 4, 'S': 5, 'V': 1}"
        """
        d = SortedDict() # Create an empty dict
        super(SortedDict, d).update(self) # using intermediate class's update , class name : SortedDict , object : d
